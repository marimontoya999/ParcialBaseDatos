...
/*select Clientes.Id, Clientes.Nombre, Pedidos.Fecha, Pedidos.TotalCompra 
from Pedidos 
JOIN Clientes on Pedidos.Id = Clientes.Id;*/

/*select Pedidos.Id, Productos.NomProducto, Detalles_Pedido.CantidadAdquirida, Detalles_Pedido.Subtotal
from Detalles_Pedido
join productos on Detalles_Pedido.Id = Productos.Id
join pedidos on Detalles_Pedido.Id = Pedidos.Id;*/